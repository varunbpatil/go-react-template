// Package shared provides shared type definitions.
package shared
...
// StartStopper is a long-running service (daemon) that can be started and stopped.
...
func NewLifecycleManager(logger *slog.Logger) *Manager {
